...
function listAll($egroup, $faaregion, $state){
  ...
  #echo "get state if passed on url ";
  #echo $_GET['state'];
  #echo "<br>";
  if(($egroup != "All")&&($egroup != "")){
  ...
  if(($state != "All")&&($state != "")){
    ...
    #echo "stateClause =$stateClause<br>";
  }
...
<tr><td colspan="3">
<!-- <a href="<?php echo "$linkName"; ?>"><font class="downloadLink">Download Data File</font> </a>(download a tab-delimited file suitable for importing into EXCEL)--></td></tr>
...
<tr>
<td class="smallText" align="left">A=2019 &le;1500 feet strikes/100,000 movements</td>
<td class="smallText" align="left">B=2019 &le;1500 feet adverse effect strikes/100,000 movements</td>
</tr>
<tr>
<td class="smallText" align="left">C=2015-2019 &le;1500 feet strikes/100,000 movements</td>
<td class="smallText" align="left"> D=2015-2019 &le;1500 adverse effect strikes/100,000 movements</td>
</tr>
</table>
<br>
